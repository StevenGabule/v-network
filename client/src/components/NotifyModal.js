...
const NotifyModal = () => {
  ...
  const handleDeleteAll = () => {
    ...
    if(window.confirm(`You have ${newArr.length} unread notices. Are you sure you want delete all?`)) {
  ...
  return (
    <div style={{minWidth: 280}}>
      ...
      <hr className='mt-0' />
      {
        notify.data.length === 0 && <img src={NoNotice} alt="no notice" className='w-100' />
      }
